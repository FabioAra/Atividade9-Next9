...
export default function Movies3() {
    ...
    const onClickHandler1 = (e) => {
        ...
        if (url1 === '') setUrl1(`https://www.omdbapi.com/?apikey=59dad974&s=${input1}`)
    ...
    const onClickHandler2 = (e) => {
        ...
        if (url2 === '') setUrl2(`https://www.omdbapi.com/?apikey=59dad974&s=${input2}`)
    ...
    const onClickHandler3 = (e) => {
        ...
        if (url3 === '') setUrl3(`https://www.omdbapi.com/?apikey=59dad974&s=${input3}`)
